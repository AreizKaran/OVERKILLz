  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: { DEFAULT: '#F97316', 50: '#FFF7ED', 600: '#EA580C' },
        ok: { DEFAULT: '#10B981', 50: '#ECFDF5', 700: '#047857' },
        warn: { DEFAULT: '#F59E0B', 50: '#FFFBEB', 700: '#B45309' },
        bad: { DEFAULT: '#EF4444', 50: '#FEF2F2', 700: '#B91C1C' },
        canvas: '#F8FAFC',
        surface: '#FFFFFF',
        subtle: '#F1F5F9',
        ink: '#0F172A',
